...
export default function Hero(): JSX.Element {
  ...
  return (
    <section className='hero relative overflow-hidden py-4'>
      <HeroGradient className='absolute top-0 left-0 w-full h-full sm:w-[140%] z-0' />
      <Container>
        <div className='hero-container max-w-1/2 md:max-w-full h-full flex flex-col justify-center items-start gap-1'>
          ...
          <Button
            className='bg-cta border-cta text-dark mt-1 xs:w-full'
