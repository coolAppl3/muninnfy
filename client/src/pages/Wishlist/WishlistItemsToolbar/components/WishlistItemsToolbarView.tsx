...
export default function WishlistItemsToolbarView(): JSX.Element {
  ...
  return (
    <button
      type='button'
      className={`flex justify-between gap-2 mr-auto px-2 bg-dark shadow-simple-tiny overflow-hidden rounded-pill relative after:absolute after:top-0 after:left-0 after:h-full after:w-1/2 after:bg-secondary after:transition-transform p-1 cursor-pointer transition-[filter_colors] hover:brightness-75 ${
