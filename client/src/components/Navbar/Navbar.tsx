        ...
        <Container className='flex justify-between items-center'>
          ...
          <div className='font-bold flex justify-center items-center absolute w-fit h-fit left-0 right-0 mx-auto'>
            <NavLink
              to='/home'
              className={({ isActive }) =>
                `mr-1 relative after:absolute after:bottom-[-2px] after:left-0 after:w-full after:h-[3px] after:rounded-pill after:bg-cta/${
                  isActive ? '100' : '0'
                } hover:after:bg-cta/100 after:transition-[background]`
              }
            >
              Home
            </NavLink>
