...
describe('isValidUuid', () => {
  it('should return false if a string not 36-characters long is provided', async () => {
  ...
  it('should return false if a non-UUIDv4 is provided', async () => {
  ...
  it('should return true if a valid UUIDv$ is provided', async () => {
